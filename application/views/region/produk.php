...
<table class="table">
  ...
  <?php foreach($produk as $p):?>
    <tr>
      ...
      <td><?=$p["harga"];?></td>
      <td><?= $p["deskripsi"];?></td>
      <td><button type="button" class="badge badge-pill badge-danger" data-toggle="modal" data-target="#modalProduk">
        Hapus
      </button><br> <a href="<?= base_url("region/");?>editProduk/<?= $p['id'];?>" class="badge badge-info">Edit</a></td>
    </tr>
    <?php endforeach;?>
  <?php endif;?>
  </tbody>
